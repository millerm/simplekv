...
impl SimpleKV {
    pub fn open(path: &Path) -> io::Result<Self> {
        let f = OpenOptions::new()
            ...
            .create(true) // Create file at `path` if it doesn't already exist
    ...
    fn process_record<R: Read>(f: &mut R) -> io::Result<KeyValuePair> {
        ...
        // Splits the collection into two at the index of the value
    ...
    pub fn load(&mut self) -> io::Result<()> {
        ...
        loop {
            ...
            // Read a record in the file at the current position.
